...
namespace WindowsFormsApp1
{
    public class PlayerSdk
    {
        ...
        public static extern int EasyPlayer_Init(string key = "6D75724D7A4969576B5A73414F7A314C744D4B6F652F4A705A586877624739795A5849755A58686C567778576F4F4E372F69426C59584E35");
        ...
        public static PlayerSdk.MediaSourceCallBack EPcallBack = null;
        /// <summary>
        /// 初始化
        /// </summary>
        public static void EPInit()
        {
            PlayerSdk.EasyPlayer_Init();
            EPcallBack = new PlayerSdk.MediaSourceCallBack(MediaCallback);
            GC.KeepAlive(EPcallBack);
        }
        static List<int> list = new List<int>();
        public static void EPlay(string url, IntPtr a, IntPtr b, IntPtr c, IntPtr d)
        {
            int channelID = PlayerSdk.EasyPlayer_OpenStream(url + 1, a, PlayerSdk.RENDER_FORMAT.DISPLAY_FORMAT_RGB24_GDI, 1, "", "", EPcallBack, IntPtr.Zero, false);
            if (channelID > 0)
            {
        ...
        public static void EStop()
        {
            ...
            {
                int m = PlayerSdk.EasyPlayer_CloseStream(i);
                if (m == 0) _list.Add(i);
            }
        ...
        /// <returns>System.Int32.</returns>
        private static int MediaCallback(int _channelId, IntPtr _channelPtr, int _frameType, IntPtr pBuf, ref PlayerSdk.EASY_FRAME_INFO _frameInfo)
        {
            return 0;
        }
    }
